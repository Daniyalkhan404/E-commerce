...
const Header = () => {
    const { user } = useUser()
    const itemCourt = useBasketStore((state) => 
    ...
    <header className="flex flex-wrap justify-between items-center px-4 py-2">
     ...
     <div className="flex w-full flex-wrap justify-between items-center">
        ...
        <div className="flex items-center space-x-4 mt-4 sm:mt-0 flex-1 sm:flex-none">
            ...
            rounded-full w-5 flex items-center justify-center text-xs">
                {itemCourt}
            </span>
           ...
           <span> My Basket </span>
            ...
            <ClerkLoaded>
                <SignedIn>
                  ...
                  items-center space-x-2 bg-blue-700 text-white font-bold py-2 px-4 rounded">
