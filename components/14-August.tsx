...
async function August() {
    const sale = await getActiveSaleByCouponCode(COUPON_CODES.AUG14);
    ...
    return (
    <div className="bg-gradient-to-r from-green-600 to-white text-black px-6
    py-10 mx-4 mt-2 rounded-lg shadow-lg">
